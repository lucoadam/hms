<template>
    <v-card>
        <v-card-title>
            ...
            ></v-text-field>
            <v-btn fab color="primary" :to="{name:'admin.locations.create'}"><v-icon>add</v-icon></v-btn>
        </v-card-title>
                <v-dialog
        ...
        >
            ...
            <template v-slot:item.actions="{item}">
                ...
                <v-btn icon :to="{ name:'admin.locations.edit', params: { id: item.id } }" primary><v-icon>create</v-icon></v-btn>
            </template>
...
<script>
    ...
    export default {
        ...
        methods:{
            getDataFromApi () {
                this.loading = true
                return LocationApi.index().then((response) => {
            ...
            deleteItem(){
                if(this.errorMessage){
                    ...
                    LocationApi.delete(this.deletingItem.id).then((res) => {
                        if (res.body.success) {
